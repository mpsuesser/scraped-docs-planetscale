...
> Run PlanetScale in your own AWS or GCP account, operated by our team with your data in your cloud.
...
<Columns cols={2}>
  <Card title="PlanetScale Managed on Amazon Web Services" icon="aws" horizontal href="/docs/plans/managed/aws" />

  <Card title="PlanetScale Managed on Google Cloud Platform" icon="google" horizontal href="/docs/plans/managed/gcp" />
</Columns>
