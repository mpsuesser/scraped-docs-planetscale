...
<PlatformAvailability current="vitess" postgres="/postgres/monitoring/query-insights" />
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/GA0k5H-MolPvBjDk/images/assets/docs/concepts/query-insights/query-insights-overview.png?fit=max&auto=format&n=GA0k5H-MolPvBjDk&q=85&s=3f1d4d7528a976ec1fc943fc96bf7172" alt="PlanetScale Insights overview page" width="2478" height="1654" data-path="images/assets/docs/concepts/query-insights/query-insights-overview.png" />
</Frame>
