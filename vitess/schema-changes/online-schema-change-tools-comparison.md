...
> Online Schema Change tools for MySQL [share a similar basic design](how-online-schema-change-tools-work.md), but differ in implementation.
...
* [Facebook's OSC](https://web.archive.org/web/2023/http://bazaar.launchpad.net/~mysqlatfacebook/mysqlatfacebook/tools/annotate/head:/osc/OnlineSchemaChange.php)
...
Make sure to first read [How Online Schema Change tools work](how-online-schema-change-tools-work.md).
