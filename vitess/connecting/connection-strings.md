---
url: https://planetscale.com/docs/vitess/connecting/connection-strings
...
Create **role credentials** with [`pscale role`](../../cli/role.md), then connect using a [connection string](../../postgres/connecting/quickstart.md).

`pscale connect` is not supported.

## Vitess / MySQL

Create a **branch password** with [`pscale password`](../../cli/password.md), then connect with a [connection string](connection-strings.md) or [`pscale connect`](../../cli/connect.md).
