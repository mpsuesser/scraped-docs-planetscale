...
> When importing a database using our [Import tool](database-imports.md), you need to grant a set of IP addresses access to your external MySQL database so that PlanetScale can make the connection.
...
<PlatformAvailability current="vitess" postgres="/postgres/imports/import-ips" />
