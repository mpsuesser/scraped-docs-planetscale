---
url: https://planetscale.com/docs/api/reference/list_maintenance_windows
title: "List_maintenance_windows"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/maintenance-schedules/{id}/windows
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/maintenance-schedules/{id}/windows:
    get:
      tags:
        - MaintenanceWindows
      ...
      responses:
        '200':
          description: Returns maintenance windows for the schedule
          headers: {}
          content:
            application/json:
              schema:
                  ...
                  data:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        updated_at:
                          type: string
                          description: When the maintenance window was last updated
                        started_at:
                          type: string
                          description: When the maintenance window started
                          nullable: true
                        finished_at:
                          type: string
                          description: When the maintenance window finished
                          nullable: true
                      required:
                        - id
                        - created_at
