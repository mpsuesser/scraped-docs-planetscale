---
url: https://planetscale.com/docs/api/reference/run_shard_configuration_profile_maintenance
title: "Run_shard_configuration_profile_maintenance"
description: ""
...
# Run maintenance for a configuration profile
...
````yaml post /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/maintenance
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/maintenance:
    post:
      tags:
        - api-neki_shard_configuration_profiles
      summary: Run maintenance for a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: run_shard_configuration_profile_maintenance
      parameters:
        - name: organization
          in: path
          required: true
