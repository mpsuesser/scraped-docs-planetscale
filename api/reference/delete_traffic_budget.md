---
url: https://planetscale.com/docs/api/reference/delete_traffic_budget
title: "Delete_traffic_budget"
description: ""
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/traffic/budgets/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/traffic/budgets/{id}:
    delete:
      tags:
        - Traffic budgets
      summary: Delete a traffic budget
      description: >-
      ...
      responses:
        '204':
          description: Traffic budget successfully deleted
          headers: {}
        '401':
