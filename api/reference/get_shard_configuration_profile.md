---
url: https://planetscale.com/docs/api/reference/get_shard_configuration_profile
title: "Get_shard_configuration_profile"
description: ""
...
# Get a configuration profile for a branch
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}:
    get:
      ...
      summary: Get a shard configuration profile for a Neki branch
      description: >-
