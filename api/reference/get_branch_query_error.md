...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/errors/{fingerprint}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/errors/{fingerprint}:
    get:
      tags:
        - api-query_insights_errors
      summary: List queries for an error fingerprint
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `read_database` |
      operationId: get_branch_query_error
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: fingerprint
          in: path
          required: true
          description: The error fingerprint
          schema:
            type: string
        - name: from
          in: query
          description: Start time for filtering queries (ISO 8601 timestamp)
          schema:
            type: string
        - name: to
          in: query
          description: End time for filtering queries (ISO 8601 timestamp)
          schema:
            type: string
        - name: period
          in: query
          description: Time period for filtering queries (e.g., '1h', '24h')
          schema:
            type: string
        - name: page
          in: query
      ...
      responses:
        '200':
          description: Returns queries that failed with the given error fingerprint
          headers: {}
          content:
            application/json:
              schema:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        password:
                          ...
                          description: The database password used for the query
                        tags:
                          items:
                            type: object
                            additionalProperties: true
                        ...
                        username:
                          type: string
                          description: The username that executed the query
                        remote_address:
                          type: string
                          description: The remote IP address of the client
                        shard_queries:
                          type: integer
                          description: The number of shard queries executed
                        rows_read:
                          type: integer
                        ...
                        created_at:
                          type: string
                          description: When the query record was created
                        updated_at:
                          type: string
                          description: When the query record was last updated
                        explainable:
                          type: boolean
                          description: Whether the query can be explained
                        truncated:
                          type: boolean
