...
description: ""
access_date: 2026-09-18T08:29:07.166Z
current_date: 2026-09-18T08:29:07.166Z
---
...
````yaml post /organizations/{organization}/teams/{team}/members
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/teams/{team}/members:
    post:
      ...
      responses:
        '200':
          description: Returns the created team membership
          headers: {}
          content:
            application/json:
              schema:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        plain_text:
                          type: string
                          description: >-
                            The plaintext password. Null except in the response
                        ...
                        read_only_region:
                          type: boolean
                          description: >-
                            Whether or not the password is scoped to a read-only
                            region
                        renewable:
                          type: boolean
