---
url: https://planetscale.com/docs/api/reference/delete_organization_billing_payment_method
title: "Delete_organization_billing_payment_method"
description: ""
...
````yaml delete /organizations/{organization}/billing/payment-method
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/billing/payment-method:
    delete:
      ...
      summary: Delete the current billing payment method
      description: >-
        Delete the current payment method for an organization
        ...
        **OAuth Scopes**
        ...
        | Organization | `write_payment_method` |
      operationId: delete_organization_billing_payment_method
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '204':
          description: The billing payment method was deleted
          headers: {}
        '401':
