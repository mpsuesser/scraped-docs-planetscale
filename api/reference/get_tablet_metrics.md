...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/metrics/tablets
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/metrics/tablets:
    get:
      tags:
        - Metrics
      summary: Get time-series tablet metrics
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_tablet_metrics
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns time-series tablet metrics
          headers: {}
          content:
            application/json:
              schema:
