...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/extensions/{extension}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/extensions/{extension}:
    patch:
      tags:
        - api-neki_shard_configuration_profile_extensions
      summary: Enable or disable an extension for a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: update_shard_configuration_profile_extension
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns the updated extension
          headers: {}
          content:
            application/json:
              schema:
        ...
        '404':
          description: Shard configuration profile or extension not found
          headers: {}
        '422':
          description: Extension cannot be enabled or disabled
        '500':
