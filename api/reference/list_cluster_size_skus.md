...
SKU names are not a closed enum and vary by organization, engine, and region. Always discover them from this endpoint rather than hard-coding values.
    ...
    get:
      ...
      parameters:
        ...
        - name: database
          in: query
          description: >-
            The database name to resolve rates for. When specified,
