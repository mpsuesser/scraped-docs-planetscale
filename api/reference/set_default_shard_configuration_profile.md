---
url: https://planetscale.com/docs/api/reference/set_default_shard_configuration_profile
title: "Set_default_shard_configuration_profile"
description: ""
...
# Set the default configuration profile for a branch
...
````yaml put /organizations/{organization}/databases/{database}/branches/{branch}/default-configuration-profile
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/default-configuration-profile:
    put:
      tags:
        - api-neki_default_shard_configuration_profiles
      summary: Set the default shard configuration profile for a Neki branch
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: set_default_shard_configuration_profile
      parameters:
        - name: organization
          in: path
          required: true
            ...
            schema:
              ...
              properties:
                configuration_profile:
                  type: string
                  description: >-
                    The name of the shard configuration profile to make the
                    default
              required:
                - configuration_profile
      responses:
        '200':
          description: Returns the new default shard configuration profile
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  ...
                  architecture:
                    type: string
                    description: The architecture of the cluster size SKU
                  cluster_size:
                    type: string
                  ...
                  metal:
                    type: boolean
                    description: >-
                      Whether shards using this configuration profile use metal
                      instances
                  replicas:
                    type: integer
                    description: >-
                      The number of replicas for shards using this configuration
                      profile
                  postgres_image_version:
                    type: string
                    description: >-
                      The PostgreSQL image used by the shard configuration
                      profile
                  latest_postgres_image_version:
                    type: string
                    description: >-
                      The latest PostgreSQL image available to the shard
                      configuration profile
                  postgres_major_version:
                    type: integer
                    description: >-
                      The PostgreSQL major version used by the shard
                      configuration profile
                  postgres_minor_version:
                    type: integer
                    description: >-
                      The PostgreSQL minor version used by the shard
                      configuration profile
                  latest_postgres_minor_version:
                    type: integer
                    description: >-
                      The latest PostgreSQL minor version available to the shard
                      configuration profile
                  shards:
                    type: integer
                  ...
                  created_at:
                    type: string
                    description: When the shard configuration profile was created
                  updated_at:
                    type: string
                    description: When the shard configuration profile was last updated
                required:
                  - id
                  - name
                  - architecture
        ...
        '404':
          description: Shard configuration profile not found
          headers: {}
        '422':
          description: Default shard configuration profile could not be updated
        '500':
