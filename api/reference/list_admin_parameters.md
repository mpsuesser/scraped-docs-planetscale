...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/admin/parameters
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/admin/parameters:
    get:
      tags:
        - api-neki_admin_parameters
      summary: List parameters for a Neki admin
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_admin_parameters
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns parameters for the admin
          headers: {}
          content:
            application/json:
              schema:
