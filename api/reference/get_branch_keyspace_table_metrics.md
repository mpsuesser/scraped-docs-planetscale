---
url: https://planetscale.com/docs/api/reference/get_branch_keyspace_table_metrics
title: "Get_branch_keyspace_table_metrics"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/metrics/keyspace-tables
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/metrics/keyspace-tables:
    get:
      tags:
        - Metrics
      summary: Get table storage metrics by keyspace
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_branch_keyspace_table_metrics
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns storage metrics keyed by keyspace and table name
          headers: {}
        '401':
