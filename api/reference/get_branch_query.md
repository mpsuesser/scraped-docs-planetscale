---
url: https://planetscale.com/docs/api/reference/get_branch_query
title: "Get_branch_query"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/queries/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/queries/{id}:
    get:
      tags:
        - api-query_insights
      summary: Retrieve a branch query
      description: >-
      ...
      responses:
        '200':
          description: Returns a specific branch query
          headers: {}
          content:
            application/json:
              schema:
