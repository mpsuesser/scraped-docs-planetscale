---
url: https://planetscale.com/docs/api/reference/list_router_size_skus
title: "List_router_size_skus"
description: ""
...
# List router size SKUs for a branch
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/router-size-skus
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/router-size-skus:
    get:
      tags:
        - api-neki_routers
      summary: List router size SKUs for a Neki branch
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_router_size_skus
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns router size SKUs
          headers: {}
          content:
            application/json:
              schema:
