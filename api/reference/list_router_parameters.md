---
url: https://planetscale.com/docs/api/reference/list_router_parameters
title: "List_router_parameters"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}/parameters
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}/parameters:
    get:
      tags:
        - api-neki_router_parameters
      summary: List parameters for a Neki router
      description: >-
      ...
      parameters:
        ...
        - name: router
          in: path
          required: true
          description: Name from `list_routers`.
          schema:
            type: string
      responses:
        '200':
          description: Returns parameters for the router
          headers: {}
          content:
            application/json:
              schema:
