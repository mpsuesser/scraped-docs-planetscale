---
url: https://planetscale.com/docs/api/reference/delete_router
title: "Delete_router"
description: ""
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}:
    delete:
      tags:
        - api-neki_routers
      summary: Delete a router from a Neki branch
      description: >-
