---
url: https://planetscale.com/docs/api/reference/get_backup_policy
title: "Get_backup_policy"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/backup-policies/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/backup-policies/{id}:
    get:
      ...
      responses:
        '200':
          description: Returns a backup policy
          headers: {}
          content:
            application/json:
              schema:
