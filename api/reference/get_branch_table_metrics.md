---
url: https://planetscale.com/docs/api/reference/get_branch_table_metrics
title: "Get_branch_table_metrics"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/metrics/tables
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/metrics/tables:
    get:
      tags:
        - Metrics
      summary: Get table storage metrics
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_branch_table_metrics
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns storage metrics keyed by table name
          headers: {}
        '401':
