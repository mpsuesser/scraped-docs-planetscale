---
url: https://planetscale.com/docs/api/reference/list_branch_change_requests
title: "List_branch_change_requests"
description: ""
                    ...
                    items:
                      ...
                      properties:
                        ...
                        confirm_shrink:
                          type: boolean
                          description: >-
                            Whether the change re-applies the current minimum
                            disk size to shrink the provisioned disk
                      required:
                        - id
                        - state
                        - started_at
