---
url: https://planetscale.com/docs/api/reference/get_switchover
title: "Get_switchover"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/switchovers/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/switchovers/{id}:
    get:
      tags:
        - Switchovers
      summary: Get a switchover
      description: >-
      ...
      responses:
        '200':
          description: Returns a switchover
          headers: {}
          content:
            application/json:
              schema:
