...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/tags/summaries
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/tags/summaries:
    get:
      tags:
        - api-query_insights_tags
      summary: List query statistics grouped by tag
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `read_database` |
      operationId: list_branch_query_tag_summaries
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: tags
          in: query
          description: Tag ids returned by the tags list endpoint
          style: form
          explode: false
          schema:
            type: array
        ...
        - name: q
          in: query
          description: Search query statistics by SQL pattern
          schema:
            type: string
        - name: from
          in: query
      ...
      responses:
        '200':
          description: Returns query statistics summaries grouped by tag
          headers: {}
          content:
            application/json:
              schema:
                    ...
                    items:
                      ...
                      properties:
                        dimensions:
                          ...
                          description: The tag names and values this summary is grouped by
                        query_count:
                          type: integer
                        ...
                        max_shard_queries:
                          type: integer
                          description: >-
                            The maximum number of shard queries for a single
                            execution
                        avg_shard_queries:
                          type: number
                        ...
                        traffic_control_warnings:
                          type: integer
                          description: >-
                            The number of executions that triggered a traffic
                            control warning
                        traffic_control_throttled:
                          type: integer
                          description: >-
                            The number of executions throttled by traffic
                            control
                        traffic_control_checked:
                          type: integer
                          description: >-
                            The number of executions checked by traffic control
                            rules
                      required:
                        - dimensions
                        - query_count
