---
url: https://planetscale.com/docs/api/reference/list_shard_configuration_profiles
title: "List_shard_configuration_profiles"
description: ""
...
# List configuration profiles for a branch
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles:
    get:
      ...
      summary: List shard configuration profiles for a Neki branch
      description: >-
                ...
                items:
                  ...
                  properties:
                    ...
                    metal:
                      type: boolean
                      description: >-
                        Whether shards using this configuration profile use
                        metal instances
                    replicas:
                      type: integer
                      description: >-
                        The number of replicas for shards using this
                    ...
                    latest_postgres_minor_version:
                      type: integer
                      description: >-
                        The latest PostgreSQL minor version available to the
                        shard configuration profile
                    shards:
                      type: integer
