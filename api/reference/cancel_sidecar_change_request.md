---
url: https://planetscale.com/docs/api/reference/cancel_sidecar_change_request
title: "Cancel_sidecar_change_request"
description: ""
...
# Cancel a change request for a sidecar
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}/changes/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}/changes/{id}:
    delete:
      tags:
        - api-neki_sidecar_changes
      summary: Cancel a change request for a Neki sidecar
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: cancel_sidecar_change_request
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        ...
        '404':
          description: Sidecar or change request not found
          headers: {}
        '500':
