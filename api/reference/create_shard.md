---
url: https://planetscale.com/docs/api/reference/create_shard
title: "Create_shard"
description: ""
...
````yaml post /organizations/{organization}/databases/{database}/branches/{branch}/shards
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/shards:
    post:
      tags:
        - api-neki_shards
      summary: Add shards to a Neki branch
      description: >-
      ...
      responses:
        '308':
          description: Redirects to the default shard configuration profile shards endpoint
          headers: {}
        '401':
