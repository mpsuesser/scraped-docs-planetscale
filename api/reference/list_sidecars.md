---
url: https://planetscale.com/docs/api/reference/list_sidecars
title: "List_sidecars"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/sidecars
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/sidecars:
    get:
      tags:
        - api-neki_sidecars
      summary: List sidecars for a Neki branch
      description: >-
      ...
      responses:
        '200':
          description: Returns sidecars for the branch, one per shard configuration profile
          headers: {}
          content:
            application/json:
              schema:
