---
url: https://planetscale.com/docs/api/reference/update_admin
title: "Update_admin"
description: ""
...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/admin
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/admin:
    patch:
      tags:
        - api-neki_admins
      summary: Update the admin for a Neki branch
      description: >-
            ...
            schema:
              ...
              properties:
                ...
                parameters:
                  ...
                  description: >-
                    Admin parameters nested by namespace (e.g., {"admin":
            ...
            application/json:
              schema:
                ...
                properties:
                  ...
                  updated_at:
                    type: string
                    description: When the admin was last updated
                required:
                  - id
                  - sku
                  - admin_size
