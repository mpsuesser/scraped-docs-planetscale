...
# Update a configuration profile for a branch
...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}:
    patch:
      tags:
        - api-neki_shard_configuration_profiles
      summary: Update a shard configuration profile for a Neki branch
      description: >-
      ...
      parameters:
        ...
        - name: configuration_profile
          in: path
          required: true
          description: Name from `list_shard_configuration_profiles`.
          schema:
            type: string
      requestBody:
        content:
          application/json:
            schema:
              ...
              properties:
                name:
                  type: string
                  description: The new name for the shard configuration profile
                cluster_size:
                  type: string
                ...
                replicas:
                  type: integer
                  description: >-
                    The new number of replicas for the shard configuration
                    profile
                parameters:
                  type: object
                  additionalProperties: true
                  description: >-
                    Configuration profile parameters nested by namespace (e.g.,
                    {"pgconf": {"max_connections": "200"}}).
                postgres_major_version:
                  type: string
                  description: >-
                    The PostgreSQL major version for the shard configuration
                    profile
                postgres_minor_version:
                  type: string
                  description: >-
                    The PostgreSQL minor version for the shard configuration
                    profile. Requires postgres_major_version when specified.
                storage:
                  type: object
                  properties:
