---
url: https://planetscale.com/docs/api/reference/update_router
title: "Update_router"
description: ""
...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}:
    patch:
      tags:
        - api-neki_routers
      summary: Update a router for a Neki branch
      description: >-
            ...
            schema:
              ...
              properties:
                ...
                parameters:
                  ...
                  description: >-
                    Router parameters nested by namespace (e.g., {"router":
                    {"replication-lag-tolerable-max": "15m"}})
      responses:
        '200':
