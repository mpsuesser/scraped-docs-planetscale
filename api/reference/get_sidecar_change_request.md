---
url: https://planetscale.com/docs/api/reference/get_sidecar_change_request
title: "Get_sidecar_change_request"
description: ""
...
# Get a change request for a sidecar
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}/changes/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}/changes/{id}:
    get:
      ...
      summary: Get a change request for a Neki sidecar
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_sidecar_change_request
      parameters:
        - name: organization
          in: path
          required: true
