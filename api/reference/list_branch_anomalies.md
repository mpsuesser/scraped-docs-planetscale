---
url: https://planetscale.com/docs/api/reference/list_branch_anomalies
title: "List_branch_anomalies"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/anomalies
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/anomalies:
    get:
      tags:
        - api-anomalies
      summary: List branch anomalies
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `read_database` |
      operationId: list_branch_anomalies
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: from
          in: query
          description: Start time for filtering anomalies (ISO 8601 timestamp)
          schema:
            type: string
        - name: to
          in: query
          description: End time for filtering anomalies (ISO 8601 timestamp)
          schema:
            type: string
        - name: period
          in: query
          description: Time period for filtering anomalies (e.g., '1h', '24h')
          schema:
            type: string
        - name: page
          in: query
      ...
      responses:
        '200':
          description: Returns anomalies detected on the branch
          headers: {}
          content:
            application/json:
              schema:
                  ...
                  data:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        period_start:
                          type: string
                          description: When the anomaly started
                        period_end:
                          type: string
                          description: When the anomaly ended
                        minutes_in_violation:
                          type: integer
                          description: >-
                            The number of minutes query latency was in violation
                            of the expected baseline
                        active:
                          type: boolean
                          description: Whether the anomaly is ongoing
                        duration:
                          type: number
                          description: The duration of the anomaly in seconds
                        metrics_start:
                          type: string
                          description: Start of the metrics window surrounding the anomaly
                        metrics_end:
                          type: string
                          description: End of the metrics window surrounding the anomaly
                        correlations:
                          type: array
                          items:
                            type: object
                            properties:
                              ...
                              r:
                                type: number
                                description: >-
                                  The correlation coefficient between the query
                                  and the anomaly
                              keyspace:
                                type: string
                              ...
                              tablet_type:
                                ...
                                enum:
                                  ...
                                  - replica
                                  - rdonly
                                description: The tablet type the query ran against
                            required:
                              - id
                              - r
                              - keyspace
