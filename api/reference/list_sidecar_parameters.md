---
url: https://planetscale.com/docs/api/reference/list_sidecar_parameters
title: "List_sidecar_parameters"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}/parameters
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}/parameters:
    get:
      tags:
        - api-neki_sidecar_parameters
      summary: List parameters for a Neki sidecar
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_sidecar_parameters
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: sidecar
          in: path
          required: true
          description: ID from `list_sidecars`, or the configuration profile name.
          schema:
            type: string
      responses:
        '200':
          description: Returns parameters for the sidecar
          headers: {}
          content:
            application/json:
              schema:
