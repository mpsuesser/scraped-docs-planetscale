---
url: https://planetscale.com/docs/api/reference/list_routers
title: "List_routers"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/routers
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/routers:
    get:
      tags:
        - api-neki_routers
      summary: List routers for a Neki branch
      description: >-
