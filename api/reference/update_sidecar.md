---
url: https://planetscale.com/docs/api/reference/update_sidecar
title: "Update_sidecar"
description: ""
...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}:
    patch:
      tags:
        - api-neki_sidecars
      summary: Update a sidecar for a Neki branch
      description: >-
            ...
            schema:
              ...
              properties:
                parameters:
                  ...
                  description: >-
                    Sidecar parameters nested by namespace (e.g., {"sidecar":
                    {"pool-capacity": "100"}})
      responses:
        '200':
          description: Returns the sidecar
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  ...
                  configuration_profile:
                    type: string
                    description: >-
                      The name of the shard configuration profile the sidecar
                      belongs to
                  state:
                    type: string
                    enum:
                  ...
                  created_at:
                    type: string
                    description: When the sidecar was created
                  updated_at:
                    type: string
                    description: When the sidecar was last updated
                required:
                  - id
                  - configuration_profile
                  - state
