---
url: https://planetscale.com/docs/api/reference/create_shard_configuration_profile
title: "Create_shard_configuration_profile"
description: ""
...
# Create a configuration profile for a branch
...
````yaml post /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles:
    post:
      ...
      summary: Create a shard configuration profile for a Neki branch
      description: >-
          ...
          application/json:
            schema:
              ...
              properties:
                ...
                cluster_size:
                  type: string
                  description: The cluster size for the shard configuration profile
                replicas:
                  type: integer
                  description: The number of replicas for the shard configuration profile
