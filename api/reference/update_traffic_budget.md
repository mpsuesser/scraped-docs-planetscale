---
url: https://planetscale.com/docs/api/reference/update_traffic_budget
title: "Update_traffic_budget"
description: ""
...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/traffic/budgets/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/traffic/budgets/{id}:
    patch:
      tags:
        - Traffic budgets
      summary: Update a traffic budget
      description: >-
      ...
      responses:
        '200':
          description: Returns the updated traffic budget
          headers: {}
          content:
            application/json:
              schema:
