---
url: https://planetscale.com/docs/api/reference/get_branch_query_tag
title: "Get_branch_query_tag"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/tags/{tag}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/tags/{tag}:
    get:
      tags:
        - api-query_insights_tags
      summary: Retrieve a query tag
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `read_database` |
      operationId: get_branch_query_tag
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: from
          in: query
          description: Start time for filtering tag values (ISO 8601 timestamp)
          schema:
            type: string
        - name: to
          in: query
          description: End time for filtering tag values (ISO 8601 timestamp)
          schema:
            type: string
        - name: period
          in: query
          description: Time period for filtering tag values (e.g., '1h', '24h')
          schema:
            type: string
        - name: fingerprint
          in: query
          description: Filter to tag values on queries with this fingerprint
          schema:
            type: string
        - name: keyspace
          in: query
        ...
        - name: values_limit
          in: query
          description: Maximum number of values returned (1-100)
          schema:
            type: integer
        - name: literal_values_only
          in: query
          description: >-
            Only return literal tag values, excluding overflow and collapsed
            values
          schema:
            type: boolean
      responses:
        '200':
          description: Returns the tag and its values
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  ...
                  query_count:
                    type: integer
                    description: The number of queries that have this tag
                  values:
                    type: array
                    items:
                      type: object
                      properties:
                        ...
                        query_count:
                          type: integer
                          description: The number of queries that have this tag value
                        kind:
                          type: string
                          enum:
                            - literal
                            - overflow
                            - collapsed
                          description: The kind of tag value
                      required:
                        - name
                        - query_count
                        - kind
