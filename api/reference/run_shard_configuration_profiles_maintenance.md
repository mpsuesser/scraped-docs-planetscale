---
url: https://planetscale.com/docs/api/reference/run_shard_configuration_profiles_maintenance
title: "Run_shard_configuration_profiles_maintenance"
description: ""
...
# Run maintenance for selected configuration profiles
...
````yaml post /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/maintenance
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/maintenance:
    post:
      tags:
        - api-neki_shard_configuration_profiles
      summary: Run maintenance for selected Neki shard configuration profiles
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: run_shard_configuration_profiles_maintenance
      parameters:
        - name: organization
          in: path
          required: true
            ...
            schema:
              ...
              properties:
                configuration_profile_names:
                  ...
                  items:
                    type: string
                  description: The names of the shard configuration profiles to maintain
              required:
                - configuration_profile_names
      responses:
        '204':
        ...
        '404':
          ...
          headers: {}
        '422':
          description: Invalid configuration profile names
        '500':
