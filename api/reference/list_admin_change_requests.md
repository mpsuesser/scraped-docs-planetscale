---
url: https://planetscale.com/docs/api/reference/list_admin_change_requests
title: "List_admin_change_requests"
description: ""
...
# List change requests for an admin
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/admin/changes
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/admin/changes:
    get:
      tags:
        - api-neki_admin_changes
      summary: List change requests for a Neki admin
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_admin_change_requests
      parameters:
        - name: organization
          in: path
          required: true
