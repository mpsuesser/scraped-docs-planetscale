---
url: https://planetscale.com/docs/api/reference/get_data_topology
title: "Get_data_topology"
description: ""
...
# Get the data topology for a branch
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/data-topology
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/data-topology:
    get:
      tags:
        - api-data_topology
      summary: Get the data topology for a Neki branch
      description: >-
      ...
      responses:
        '200':
          description: Returns the data topology for the branch
          headers: {}
          content:
            application/json:
              schema:
