---
url: https://planetscale.com/docs/api/reference/update_backup_policy
title: "Update_backup_policy"
description: ""
...
````yaml patch /organizations/{organization}/databases/{database}/backup-policies/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/backup-policies/{id}:
    patch:
      tags:
        - BackupPolicies
      ...
      responses:
        '200':
          description: Returns the updated backup policy
          headers: {}
          content:
            application/json:
              schema:
