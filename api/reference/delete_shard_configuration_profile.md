---
url: https://planetscale.com/docs/api/reference/delete_shard_configuration_profile
title: "Delete_shard_configuration_profile"
description: ""
...
# Delete a configuration profile for a branch
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}:
    delete:
      ...
      summary: Delete a shard configuration profile for a Neki branch
      description: >-
      ...
      responses:
        '204':
          description: Shard configuration profile deleted
          headers: {}
        '401':
