---
url: https://planetscale.com/docs/api/reference/get_traffic_budget
title: "Get_traffic_budget"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/traffic/budgets/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/traffic/budgets/{id}:
    get:
      ...
      responses:
        '200':
          description: Returns the traffic budget
          headers: {}
          content:
            application/json:
              schema:
