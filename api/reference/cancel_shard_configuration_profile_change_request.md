---
url: https://planetscale.com/docs/api/reference/cancel_shard_configuration_profile_change_request
title: "Cancel_shard_configuration_profile_change_request"
description: ""
...
# Cancel a change request for a configuration profile
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/changes/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/changes/{id}:
    delete:
      tags:
        - api-neki_shard_configuration_profile_changes
      summary: Cancel a change request for a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: cancel_shard_configuration_profile_change_request
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '308':
          description: Redirects to the Neki change request endpoint
          headers: {}
        '401':
        ...
        '404':
          description: Shard configuration profile or change request not found
          headers: {}
        '500':
