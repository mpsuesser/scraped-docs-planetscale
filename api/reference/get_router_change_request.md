---
url: https://planetscale.com/docs/api/reference/get_router_change_request
title: "Get_router_change_request"
description: ""
...
# Get a change request for a router
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}/changes/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}/changes/{id}:
    get:
      ...
      summary: Get a change request for a Neki router
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_router_change_request
      parameters:
        - name: organization
          in: path
          required: true
