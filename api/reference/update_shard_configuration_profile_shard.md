---
url: https://planetscale.com/docs/api/reference/update_shard_configuration_profile_shard
title: "Update_shard_configuration_profile_shard"
description: ""
...
# Update a shard in a configuration profile
...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards/{id}:
    patch:
      tags:
        - api-neki_shard_configuration_profile_shards
      summary: Update a shard in a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: update_shard_configuration_profile_shard
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns the updated shard
          headers: {}
          content:
            application/json:
              schema:
