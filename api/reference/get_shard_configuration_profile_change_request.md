---
url: https://planetscale.com/docs/api/reference/get_shard_configuration_profile_change_request
title: "Get_shard_configuration_profile_change_request"
description: ""
...
# Get a change request for a configuration profile
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/changes/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/changes/{id}:
    get:
      ...
      summary: Get a change request for a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_shard_configuration_profile_change_request
      parameters:
        - name: organization
          in: path
          required: true
