---
url: https://planetscale.com/docs/api/reference/list_shard_configuration_profile_shards
title: "List_shard_configuration_profile_shards"
description: ""
...
# List shards for a configuration profile
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards:
    get:
      ...
      summary: List shards for a Neki shard configuration profile
      description: >-
      ...
      parameters:
        ...
        - name: q
          in: query
          description: Search shards by name or display name
          schema:
            type: string
      responses:
        '200':
          description: Returns shards for the shard configuration profile
          headers: {}
          content:
            application/json:
              schema:
