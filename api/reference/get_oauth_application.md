                ...
                properties:
                  ...
                  mcp_tool_groups:
                    ...
                    description: >-
                      ...
                      organization-tier scope names granting the group across
                      all databases in an organization) and org_roles (the
                      organization roles allowed to grant them); both are null
                      for organization-section groups
                    nullable: true
                required:
                  - id
                  - name
