---
url: https://planetscale.com/docs/api/reference/get_admin_change_request
title: "Get_admin_change_request"
description: ""
...
# Get a change request for an admin
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/admin/changes/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/admin/changes/{id}:
    get:
      ...
      summary: Get a change request for a Neki admin
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_admin_change_request
      parameters:
        - name: organization
          in: path
          required: true
