---
url: https://planetscale.com/docs/api/reference/bulk_create_shard_configuration_profile_shards
title: "Bulk_create_shard_configuration_profile_shards"
description: ""
...
# Add shards to a configuration profile
...
````yaml post /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards/bulk
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards/bulk:
    post:
      tags:
        - api-neki_shard_configuration_profile_shards
      summary: Add shards to a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: bulk_create_shard_configuration_profile_shards
      parameters:
        - name: organization
          in: path
          required: true
          ...
          application/json:
            schema:
              ...
              properties:
                count:
                  type: integer
                  description: The number of shards to add
              required:
                - count
      responses:
        '201':
          description: Returns the created shard IDs
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  ...
                  shard_ids:
                    ...
                    items:
                      type: string
                    description: The public IDs of the created shards
                required:
                  - created
                  - shard_ids
        '401':
        ...
        '404':
          ...
          headers: {}
        '422':
          description: Shards could not be created
        '500':
