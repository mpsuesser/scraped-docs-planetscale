---
url: https://planetscale.com/docs/api/reference/get_branch_anomaly
title: "Get_branch_anomaly"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/anomalies/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/anomalies/{id}:
    get:
      tags:
        - api-anomalies
      summary: Retrieve a branch anomaly
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `read_database` |
      operationId: get_branch_anomaly
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns the anomaly and its correlated queries
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  ...
                  minutes_in_violation:
                    type: integer
                    description: >-
                      The number of minutes query latency was in violation of
                    ...
                    items:
                      ...
                      properties:
                        ...
                        r:
                          type: number
                          description: >-
                            The correlation coefficient between the query and
                            the anomaly
                        keyspace:
                          type: string
