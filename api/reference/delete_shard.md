---
url: https://planetscale.com/docs/api/reference/delete_shard
title: "Delete_shard"
description: ""
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/shards/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/shards/{id}:
    delete:
      tags:
        - api-neki_shards
      summary: Remove a shard from a Neki branch
      description: >-
      ...
      responses:
        '308':
          description: Redirects to the shard configuration profile shard endpoint
          headers: {}
        '401':
