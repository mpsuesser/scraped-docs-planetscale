...
````yaml post /organizations/{organization}/databases/{database}/branches/{branch}/routers
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/routers:
    post:
      tags:
        - api-neki_routers
      summary: Create a router for a Neki branch
      description: >-
            ...
            schema:
              ...
              properties:
                name:
                  type: string
                  description: >-
                    The name of the router group. Letters, digits, dashes, and
                    underscores; 1-64 characters; cannot start or end with a
                    dash or underscore. `new`, `primary`, and `replica` are
                    reserved. Clients connect through the group by appending it
                    to the username, e.g. `user|my-router`.
                router_size:
                  type: string
                  description: >-
                    The router size SKU, e.g. `NKR_1`. Defaults to the service's
                    default size.
                replicas_per_cell:
                  type: integer
                  description: >-
                    The number of router instances per availability zone.
                    Defaults to the service's default count.
              required:
                - name
      responses:
        '201':
          description: Returns the created router
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  ...
                  sku:
                    ...
                    properties:
                      name:
                        type: string
                        description: The name of the Neki router SKU
                      display_name:
                        type: string
                      ...
                      sort_order:
                        type: integer
                        description: The sort order of the Neki router SKU
                      rate:
                        type: number
                  ...
                  max_replicas_per_cell:
                    type: integer
                    description: >-
                      The maximum count of replicas in each cell when
                      autoscaling
                    nullable: true
                  ...
                  updated_at:
                    type: string
                    description: When the router was last updated
                required:
                  - id
                  - name
                  - default
