---
url: https://planetscale.com/docs/api/reference/get_router
title: "Get_router"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}:
    get:
      tags:
        - api-neki_routers
      summary: Get a router for a Neki branch
      description: >-
