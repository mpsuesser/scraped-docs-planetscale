---
url: https://planetscale.com/docs/api/reference/list_branch_query_tags
title: "List_branch_query_tags"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/tags
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/tags:
    get:
      tags:
        - api-query_insights_tags
      summary: List query tags
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `read_database` |
      operationId: list_branch_query_tags
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: from
          in: query
          description: Start time for filtering tags (ISO 8601 timestamp)
          schema:
            type: string
        - name: to
          in: query
          description: End time for filtering tags (ISO 8601 timestamp)
          schema:
            type: string
        - name: period
          in: query
          description: Time period for filtering tags (e.g., '1h', '24h')
          schema:
            type: string
        - name: fingerprint
          in: query
          description: Filter to tags on queries with this fingerprint
          schema:
            type: string
        - name: keyspace
          in: query
        ...
        - name: values_limit
          in: query
          description: Maximum number of values returned per tag (1-100)
          schema:
            type: integer
      ...
      responses:
        '200':
          description: Returns tags found on branch queries
          headers: {}
          content:
            application/json:
              schema:
