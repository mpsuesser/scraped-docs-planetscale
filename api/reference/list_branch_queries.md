...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights:
    get:
      tags:
        - api-query_insights
      ...
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `read_database` |
      operationId: list_branch_queries
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns query statistics summaries
          headers: {}
          content:
            application/json:
              schema:
