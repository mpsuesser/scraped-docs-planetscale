...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/metrics/tablets-instant
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/metrics/tablets-instant:
    get:
      tags:
        - Metrics
      summary: Get current tablet metrics
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_instant_tablet_metrics
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns current tablet metrics
          headers: {}
          content:
            application/json:
              schema:
                  ...
                  metrics:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        label:
                          type: string
                          description: A human-readable metric label
                        values:
                          type: array
                          items:
                            type: object
                            properties:
                              ...
                              role:
                                type: string
                                description: Postgres role (primary or replica)
                              value:
                                type: number
