---
url: https://planetscale.com/docs/api/reference/list_router_change_requests
title: "List_router_change_requests"
description: ""
...
# List change requests for a router
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}/changes
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/routers/{router}/changes:
    get:
      tags:
        - api-neki_router_changes
      summary: List change requests for a Neki router
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_router_change_requests
      parameters:
        - name: organization
          in: path
          required: true
