---
url: https://planetscale.com/docs/api/reference/update_shard
title: "Update_shard"
description: ""
...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/shards/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/shards/{id}:
    patch:
      tags:
        - api-neki_shards
      summary: Update a shard for a Neki branch
      description: >-
