---
url: https://planetscale.com/docs/api/reference/get_shard_configuration_profile_shard
title: "Get_shard_configuration_profile_shard"
description: ""
...
# Get a shard in a configuration profile
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards/{id}:
    get:
      ...
      summary: Get a shard in a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_shard_configuration_profile_shard
      parameters:
        - name: organization
          in: path
          required: true
