---
url: https://planetscale.com/docs/api/reference/update_data_topology
title: "Update_data_topology"
description: ""
...
# Set the data topology for a branch
...
````yaml put /organizations/{organization}/databases/{database}/branches/{branch}/data-topology
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/data-topology:
    put:
      tags:
        - api-data_topology
      summary: Set the data topology for a Neki branch
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `write_branch` |
      operationId: update_data_topology
      parameters:
        - name: organization
          in: path
          required: true
            ...
            schema:
              ...
              properties:
                data_topology:
                  ...
                  description: The data topology JSON to set for the branch
              required:
                - data_topology
      responses:
        '200':
          description: Returns the updated data topology for the branch
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  data_topology:
                    type: object
                    additionalProperties: true
                    description: The data topology for the branch
                  synced_at:
                    type: string
                    description: When the data topology was last synced
                    nullable: true
                required:
                  - data_topology
                  - synced_at
