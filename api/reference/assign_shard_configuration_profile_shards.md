...
description: ""
access_date: 2026-09-17T07:58:00.471Z
current_date: 2026-09-17T07:58:00.471Z
---
...
# Assign shards to a configuration profile
...
````yaml patch /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards:
    patch:
      tags:
        - api-neki_shard_configuration_profile_shards
      summary: Assign shards to a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: assign_shard_configuration_profile_shards
      parameters:
        - name: organization
          in: path
          required: true
            ...
            schema:
              ...
              properties:
                shard_ids:
                  ...
                  items:
                    type: string
                  description: The IDs of the shards to assign
              required:
                - shard_ids
      responses:
        '200':
          description: Returns an assignment result for each requested shard
          headers: {}
          content:
            application/json:
              schema:
                ...
                items:
                  ...
                  properties:
                    id:
                      type: string
                      description: The public ID of the shard
                    status:
                      type: string
                      description: One of assigned, unchanged, or failed
                    error:
                      type: object
                      additionalProperties: true
                      description: The assignment error
                      nullable: true
                  required:
                    - id
                    - status
        ...
        '404':
          description: Shard configuration profile or shard not found
          headers: {}
        '422':
          description: Invalid shard IDs
        '500':
