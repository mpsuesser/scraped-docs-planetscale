...
# List change requests for a branch
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/neki-changes
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/neki-changes:
    get:
      tags:
        - api-neki_changes
      summary: List change requests for a Neki branch
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_neki_change_requests
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: state
          in: query
          description: Filter change requests by state
          style: form
          explode: false
          schema:
            type: array
        ...
        - name: target_id
          in: query
          description: Filter change requests by target ID. Requires target_types
          schema:
            type: string
        - name: period
          in: query
      ...
      responses:
        '200':
          description: Returns Neki change requests
          headers: {}
          content:
            application/json:
              schema:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        autoscaling:
                          type: boolean
                          description: >-
                            Whether the router scales horizontally within each
                            cell
                          nullable: true
                        ...
                        previous_target_cpu_utilization:
                          type: integer
                          description: >-
                            The previous target average CPU utilization
                            percentage
                          nullable: true
                        name:
                          type: string
                        ...
                        storage:
                          ...
                          properties:
                            ...
                            maximum_storage_bytes:
                              type: integer
                              description: >-
                                The maximum storage size in bytes for
                                autoscaling
                              nullable: true
                            storage_autoscaling:
                              type: boolean
                        ...
                        previous_metal:
                          type: boolean
                          description: >-
                            Whether the previous cluster size SKU used metal
                            instances
                          nullable: true
