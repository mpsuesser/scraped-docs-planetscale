---
url: https://planetscale.com/docs/api/reference/get_query_statistics
title: "Get_query_statistics"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/{fingerprint}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/{fingerprint}:
    get:
      tags:
        - api-query_insights
      summary: Retrieve query statistics
      description: >-
      ...
      responses:
        '200':
          description: Returns detailed query statistics
          headers: {}
          content:
            application/json:
              schema:
