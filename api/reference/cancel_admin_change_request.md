---
url: https://planetscale.com/docs/api/reference/cancel_admin_change_request
title: "Cancel_admin_change_request"
description: ""
...
# Cancel a change request for an admin
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/admin/changes/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/admin/changes/{id}:
    delete:
      tags:
        - api-neki_admin_changes
      summary: Cancel a change request for a Neki admin
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: cancel_admin_change_request
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        ...
        '404':
          description: Admin or change request not found
          headers: {}
        '500':
