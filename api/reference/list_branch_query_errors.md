---
url: https://planetscale.com/docs/api/reference/list_branch_query_errors
title: "List_branch_query_errors"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/errors
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/errors:
    get:
      tags:
        - api-query_insights_errors
      summary: List branch query errors
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `read_database` |
      operationId: list_branch_query_errors
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: q
          in: query
          description: Search query errors by error message
          schema:
            type: string
        - name: from
          in: query
          description: Start time for filtering query errors (ISO 8601 timestamp)
          schema:
            type: string
        - name: to
          in: query
          description: End time for filtering query errors (ISO 8601 timestamp)
          schema:
            type: string
        - name: period
          in: query
          description: Time period for filtering query errors (e.g., '1h', '24h')
          schema:
            type: string
        - name: sort
          in: query
      ...
      responses:
        '200':
          description: Returns query error summaries
          headers: {}
          content:
            application/json:
              schema:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        total_duration_millis:
                          type: integer
                          description: >-
                            Total duration in milliseconds across all failed
                            executions
                        time_per_query:
                          type: number
                          description: >-
                            Average duration per failed execution in
                            milliseconds
                        error_count:
                          type: integer
