...
````yaml get /organizations/{organization}/teams/{team}/members/{id}
openapi: 3.0.1
info:
    ...
    get:
      ...
      parameters:
        ...
        - name: id
          in: path
          required: true
          description: The ID of the team membership or the ID of the member
          schema:
            type: string
      responses:
        '200':
          description: Returns the team member details
          headers: {}
          content:
            application/json:
              schema:
