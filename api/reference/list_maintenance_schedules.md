---
url: https://planetscale.com/docs/api/reference/list_maintenance_schedules
title: "List_maintenance_schedules"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/maintenance-schedules
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/maintenance-schedules:
    get:
      tags:
      ...
      responses:
        '200':
          description: Returns maintenance schedules for the database
          headers: {}
          content:
            application/json:
              schema:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        day:
                          type: integer
                          description: >-
                            Day of the week (0 = Sunday, 6 = Saturday, 7 = every
                            day)
                        hour:
                          type: integer
