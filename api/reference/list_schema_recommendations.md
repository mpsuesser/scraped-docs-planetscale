---
url: https://planetscale.com/docs/api/reference/list_schema_recommendations
title: "List_schema_recommendations"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/schema-recommendations
openapi: 3.0.1
info:
  ...
  /organizations/{organization}/databases/{database}/schema-recommendations:
    get:
      ...
      parameters:
        ...
        - name: state
          in: query
          description: Filter by recommendation state
          schema:
            type: string
            enum:
              - open
      ...
      responses:
        '200':
          description: Returns schema recommendations
          headers: {}
          content:
            application/json:
              schema:
