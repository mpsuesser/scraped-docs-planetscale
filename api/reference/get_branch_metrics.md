...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/metrics
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/metrics:
    get:
      tags:
        - Metrics
      ...
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_branch_metrics
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: query_ids
          in: query
          description: Filter by query pattern IDs
          style: form
          explode: false
          schema:
            type: array
