---
url: https://planetscale.com/docs/api/reference/delete_shard_configuration_profile_shards
title: "Delete_shard_configuration_profile_shards"
description: ""
...
# Remove shards from a configuration profile
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards:
    delete:
      ...
      summary: Remove shards from a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: delete_shard_configuration_profile_shards
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: shard_ids
          in: query
          required: true
          description: The IDs of the shards to remove
          style: form
          explode: false
          schema:
            type: array
      ...
      responses:
        ...
        '404':
          ...
          headers: {}
        '422':
          description: Shards could not be removed
        '500':
