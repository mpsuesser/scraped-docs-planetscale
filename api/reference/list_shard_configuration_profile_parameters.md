---
url: https://planetscale.com/docs/api/reference/list_shard_configuration_profile_parameters
title: "List_shard_configuration_profile_parameters"
description: ""
...
# List parameters for a configuration profile
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/parameters
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/parameters:
    get:
      tags:
        - api-neki_shard_configuration_profile_parameters
      summary: List parameters for a Neki shard configuration profile
      description: >-
      ...
      responses:
        '200':
          description: Returns parameters for the shard configuration profile
          headers: {}
          content:
            application/json:
              schema:
                ...
                items:
                  ...
                  properties:
                    ...
                    advanced:
                      type: boolean
                      description: Whether the parameter is advanced
                    category:
                      type: string
                    ...
                    restart:
                      type: boolean
                      description: >-
                        Whether processes require a server restart after the
                        parameter changes
                    max:
                      type: number
                    ...
                    options:
                      ...
                      type: array
                      description: >-
                        Valid options for the parameter value. Null represents
                        an unset value
                      nullable: true
                    units:
                      items:
                        type: string
                      type: array
                      description: The units of the parameter value
                      nullable: true
                    url:
                      type: string
