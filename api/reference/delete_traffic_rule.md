---
url: https://planetscale.com/docs/api/reference/delete_traffic_rule
title: "Delete_traffic_rule"
description: ""
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/traffic/budgets/{budget_id}/rules/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/traffic/budgets/{budget_id}/rules/{id}:
    delete:
      tags:
        - Traffic rules
      summary: Delete a traffic rule
      description: >-
      ...
      responses:
        '204':
          description: Traffic rule successfully deleted
          headers: {}
        '401':
