---
url: https://planetscale.com/docs/api/reference/list_traffic_budgets_for_query
title: "List_traffic_budgets_for_query"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/insights/{fingerprint}/traffic/budgets
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/insights/{fingerprint}/traffic/budgets:
    get:
      tags:
        - api-query_insights_traffic_budgets
      summary: List traffic budgets affecting a query fingerprint
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_traffic_budgets_for_query
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: keyspace
          in: query
          description: Optional keyspace filter
          schema:
            type: string
      responses:
        '200':
          description: Returns the traffic budgets affecting the query fingerprint
          headers: {}
          content:
            application/json:
              schema:
                    ...
                    items:
                      ...
                      properties:
                        ...
                        capacity:
                          type: number
                          description: >-
                            The maximum capacity that can be banked, measured as
                            a percentage of seconds of full server usage
                            (0-6000). Unlimited when not set.
                          nullable: true
                        rate:
                          type: number
                          description: >-
                            The rate at which capacity refills, as a percentage
                            of server resources (0-100). Unlimited when not set.
                          nullable: true
                        burst:
                          type: number
                          description: >-
                            The maximum capacity a single query can consume,
                            measured as a percentage of seconds of full server
                            usage (0-6000). Unlimited when not set.
                          nullable: true
                        concurrency:
                          type: number
                          description: >-
                            The percentage of available worker processes this
                            policy can use (0-100). Unlimited when not set.
                          nullable: true
                        warning_threshold:
                          type: number
                          description: >-
                            A percentage of capacity, burst, or concurrency
                            thresholds to emit warnings for enforced budgets
                            (0-100).
                          nullable: true
                        actor:
                          type: object
