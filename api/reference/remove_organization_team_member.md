...
description: ""
access_date: 2026-09-18T17:54:39.952Z
current_date: 2026-09-18T17:54:39.952Z
---
...
````yaml delete /organizations/{organization}/teams/{team}/members/{id}
openapi: 3.0.1
info:
    ...
    delete:
      ...
      parameters:
        ...
        - name: id
          in: path
          required: true
          description: The ID of the team membership or the ID of the member to remove
          schema:
            type: string
        - name: delete_passwords
          in: query
          description: Whether to delete the member's passwords created through this team
          schema:
            type: boolean
      responses:
        '204':
          description: >-
            Member removed successfully. Note: SSO-managed teams cannot have
            members removed.
          headers: {}
        '400':
