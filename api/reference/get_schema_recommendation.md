---
url: https://planetscale.com/docs/api/reference/get_schema_recommendation
title: "Get_schema_recommendation"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/schema-recommendations/{number}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/schema-recommendations/{number}:
    get:
      tags:
        - Schema recommendations
      summary: Get a schema recommendation
      description: >-
      ...
      responses:
        '200':
          description: Returns a schema recommendation
          headers: {}
          content:
            application/json:
              schema:
