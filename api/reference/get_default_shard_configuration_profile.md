---
url: https://planetscale.com/docs/api/reference/get_default_shard_configuration_profile
title: "Get_default_shard_configuration_profile"
description: ""
...
# Get the default configuration profile for a branch
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/default-configuration-profile
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/default-configuration-profile:
    get:
      ...
      summary: Get the default shard configuration profile for a Neki branch
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_default_shard_configuration_profile
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '302':
          description: Redirects to the default shard configuration profile
          headers: {}
        '401':
        ...
        '404':
          description: Default shard configuration profile not found
          headers: {}
        '500':
