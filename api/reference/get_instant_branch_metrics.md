...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/metrics/instant
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/metrics/instant:
    get:
      tags:
        - Metrics
      ...
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_instant_branch_metrics
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: role
          in: query
          description: Filter by Postgres role
          schema:
            type: string
        - name: shard
          in: query
