---
url: https://planetscale.com/docs/api/reference/delete_shard_configuration_profile_shard
title: "Delete_shard_configuration_profile_shard"
description: ""
...
# Remove a shard from a configuration profile
...
````yaml delete /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards/{id}:
    delete:
      ...
      summary: Remove a shard from a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: delete_shard_configuration_profile_shard
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        ...
        '404':
          ...
          headers: {}
        '422':
          description: Shard could not be removed
        '500':
