...
# List extensions for a configuration profile
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/extensions
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/extensions:
    get:
      tags:
        - api-neki_shard_configuration_profile_extensions
      summary: List extensions for a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_shard_configuration_profile_extensions
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns extensions for the shard configuration profile
          headers: {}
          content:
            application/json:
              schema:
                ...
                items:
                  ...
                  properties:
                    ...
                    enabled:
                      type: boolean
                      description: >-
                        Whether the extension is enabled by the configuration
                        profile
                      nullable: true
                    internal:
                      type: boolean
                      ...
                      items:
                        ...
                        properties:
                          ...
                          restart:
                            type: boolean
                            description: >-
                              Whether processes require a server restart after
                          ...
                          options:
                            ...
                            type: array
                            description: >-
                              Valid options for the parameter value. Null
