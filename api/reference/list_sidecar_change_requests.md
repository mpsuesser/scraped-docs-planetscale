---
url: https://planetscale.com/docs/api/reference/list_sidecar_change_requests
title: "List_sidecar_change_requests"
description: ""
...
# List change requests for a sidecar
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}/changes
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}/changes:
    get:
      tags:
        - api-neki_sidecar_changes
      summary: List change requests for a Neki sidecar
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_sidecar_change_requests
      parameters:
        - name: organization
          in: path
          required: true
