---
url: https://planetscale.com/docs/api/reference/create_switchover
title: "Create_switchover"
description: ""
...
````yaml post /organizations/{organization}/databases/{database}/branches/{branch}/switchovers
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/switchovers:
    post:
      tags:
        - Switchovers
      summary: Create a switchover
      description: >2-
                Moves the primary of a Postgres branch.
            ...
            schema:
              ...
              properties:
                candidate:
                  type: string
                  description: >-
                    The exact `name` of the replica returned by the branch's
                    Postgres infrastructure endpoint to promote. Omit to let the
                    operator select an eligible replica. Only applies to
                    branches with replicas.
      responses:
        '201':
          description: Returns the new switchover
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  id:
                    type: string
                    description: The ID of the switchover
                  state:
                    type: string
                    enum:
                      - pending
                      ...
                      - failed
                      - canceled
                    description: The state of the switchover
                  method:
                    type: string
                    enum:
                      - switchover
                      - restart
                    description: >-
                      How the primary was moved. `switchover` promotes a replica
                      on a highly available branch; `restart` restarts the
                      single instance of a branch that has no replicas. Absent
                      until the operator selects one.
                    nullable: true
                  error:
                    type: string
                    description: >-
                      Why the switchover failed. A failed switchover has an
                      unconfirmed outcome and does not imply the primary stayed
                      put.
                    nullable: true
                  started_at:
                    type: string
                    description: When the switchover was requested
                    nullable: true
                  completed_at:
                    type: string
                    description: When the switchover finished
                    nullable: true
                  created_at:
                    type: string
                    description: When the switchover was created
                  updated_at:
                    type: string
                    description: When the switchover was last updated
                  actor:
                    type: object
                    properties:
                      id:
                ...
                required:
                  ...
                  - actor
        '400':
          description: 'bad request: candidate must be a string'
        '401':
        ...
        '422':
          description: 'unprocessable: the branch cannot accept a switchover right now'
        '500':
