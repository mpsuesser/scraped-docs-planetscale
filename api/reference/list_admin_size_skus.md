---
url: https://planetscale.com/docs/api/reference/list_admin_size_skus
title: "List_admin_size_skus"
description: ""
...
# List admin size SKUs for a branch
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/admin-size-skus
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/admin-size-skus:
    get:
      tags:
        - api-neki_admins
      summary: List admin size SKUs for a Neki branch
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_admin_size_skus
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns admin size SKUs
          headers: {}
          content:
            application/json:
              schema:
                ...
                items:
                  ...
                  properties:
                    name:
                      type: string
                      description: The name of the Neki admin SKU
                    display_name:
                      type: string
                    ...
                    sort_order:
                      type: integer
                      description: The sort order of the Neki admin SKU
                  required:
                    - name
                    - display_name
                    - cpu
