---
url: https://planetscale.com/docs/api/reference/get_shard
title: "Get_shard"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/shards/{id}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/shards/{id}:
    get:
      tags:
        - api-neki_shards
      summary: Get a shard for a Neki branch
      description: >-
