---
url: https://planetscale.com/docs/api/reference/create_shard_configuration_profile_shard
title: "Create_shard_configuration_profile_shard"
description: ""
...
# Add a shard to a configuration profile
...
````yaml post /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/shards:
    post:
      ...
      summary: Add a shard to a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Database | `write_database` |
      operationId: create_shard_configuration_profile_shard
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '201':
          description: Returns the created shard
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  ...
                  created_at:
                    type: string
                    description: When the shard was created
                  ready:
                    type: boolean
                  ...
                  authoritative:
                    type: boolean
                    description: >-
                      Whether the shard is the authoritative shard of the
                      cluster
                required:
                  - id
                  - name
        ...
        '404':
          ...
          headers: {}
        '422':
          description: Shard could not be created
        '500':
