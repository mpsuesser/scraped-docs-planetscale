---
url: https://planetscale.com/docs/api/reference/list_shard_configuration_profile_change_requests
title: "List_shard_configuration_profile_change_requests"
description: ""
...
# List change requests for a configuration profile
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/changes
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/configuration-profiles/{configuration_profile}/changes:
    get:
      tags:
        - api-neki_shard_configuration_profile_changes
      summary: List change requests for a Neki shard configuration profile
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: list_shard_configuration_profile_change_requests
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '308':
          description: Redirects to the Neki change requests endpoint
          headers: {}
        '401':
