---
url: https://planetscale.com/docs/api/reference/get_organization_billing_payment_method
title: "Get_organization_billing_payment_method"
description: ""
...
````yaml get /organizations/{organization}/billing/payment-method
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/billing/payment-method:
    get:
      tags:
        - Billing payment method
      summary: Get the current billing payment method
      description: >-
        Get the current payment method for an organization
        ...
        **OAuth Scopes**
        ...
        | Organization | `read_payment_method` |
      operationId: get_organization_billing_payment_method
      parameters:
        - name: organization
          in: path
          required: true
      ...
      responses:
        '200':
          description: Returns the organization's payment method
          headers: {}
          content:
            application/json:
              schema:
                ...
                properties:
                  ...
                  brand:
                    type: string
                    description: The card brand, such as visa or mastercard
                  last4:
                    type: string
                    description: The final four digits of the card number
                  exp_month:
                    type: integer
