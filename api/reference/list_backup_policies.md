---
url: https://planetscale.com/docs/api/reference/list_backup_policies
title: "List_backup_policies"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/backup-policies
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/backup-policies:
    get:
      ...
      responses:
        '200':
          description: Returns backup policies for the database
          headers: {}
          content:
            application/json:
              schema:
