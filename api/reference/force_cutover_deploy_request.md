...
````yaml post /organizations/{organization}/databases/{database}/deploy-requests/{number}/force-cutover
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/deploy-requests/{number}/force-cutover:
    post:
      tags:
        - Deploy requests
      summary: Enable force cutover for a deploy request
      description: >-
      ...
      responses:
        '200':
          description: Returns the deploy request
          headers: {}
          content:
            application/json:
              schema:
