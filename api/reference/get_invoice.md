---
url: https://planetscale.com/docs/api/reference/get_invoice
title: "Get_invoice"
description: ""
    ...
    get:
      ...
      parameters:
        ...
        - name: id
          in: path
          required: true
          description: 'Invoice public ID from `list_invoices`. Example: `aabb12123434`.'
          schema:
            type: string
      responses:
        '200':
              ...
              schema:
                ...
                properties:
                  ...
                  total:
                    type: string
                    description: >-
                      The total amount of the invoice, as a stringified decimal
                  ...
                  overdue:
                    type: boolean
                    description: Whether the invoice is past due and unpaid
                required:
                  - id
                  - total
                  - billing_period_start
