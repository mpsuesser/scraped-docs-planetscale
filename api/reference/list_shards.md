---
url: https://planetscale.com/docs/api/reference/list_shards
title: "List_shards"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/shards
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/shards:
    get:
      tags:
        - api-neki_shards
      summary: List shards for a Neki branch
      description: >-
      ...
      parameters:
        ...
        - name: per_page
          ...
          schema:
            type: integer
            default: 25
        - name: exclude_configuration_profile
          in: query
          description: Exclude shards in this shard configuration profile
          schema:
            type: string
        - name: q
          in: query
          description: Search shards by name, display name, or configuration profile
          schema:
            type: string
      responses:
        '200':
          description: Returns shards for the branch
          headers: {}
          content:
            application/json:
              schema:
