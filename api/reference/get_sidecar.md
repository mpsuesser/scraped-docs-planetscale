---
url: https://planetscale.com/docs/api/reference/get_sidecar
title: "Get_sidecar"
description: ""
...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/sidecars/{sidecar}:
    get:
      tags:
        - api-neki_sidecars
      summary: Get a sidecar for a Neki branch
      description: >-
