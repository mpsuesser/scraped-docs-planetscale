...
````yaml get /organizations/{organization}/databases/{database}/branches/{branch}/metrics/query
openapi: 3.0.1
info:
...
paths:
  /organizations/{organization}/databases/{database}/branches/{branch}/metrics/query:
    get:
      tags:
        - Metrics
      summary: Get time-series metrics for SQL queries
      description: >-
        ...
        **OAuth Scopes**
        ...
        | Branch | `read_branch` |
      operationId: get_branch_query_metrics
      parameters:
        - name: organization
          in: path
          required: true
        ...
        - name: query_ids
          in: query
          description: Query pattern IDs to retrieve metrics for
          style: form
          explode: false
          schema:
            type: array
        ...
        - name: fingerprint
          in: query
          description: Filter by query fingerprint
          schema:
            type: string
        - name: keyspace
          in: query
          description: Keyspace for the query fingerprint
          schema:
            type: string
        - name: period
          in: query
      ...
      responses:
        '200':
          description: Returns time-series metrics for SQL queries
          headers: {}
          content:
            application/json:
              schema:
