---
url: https://planetscale.com/docs/api/reference/delete_backup_policy
title: "Delete_backup_policy"
description: ""
...
````yaml delete /organizations/{organization}/databases/{database}/backup-policies/{id}
openapi: 3.0.1
info:
