...
> PlanetScale [Metal](../metal.md) databases offer performance benefits for many types of workloads.
...
When upgrading your existing PlanetScale database to Metal, it's useful to know where to look to see how the upgrade has improved performance.
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-p50-p95-p99.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=55387327f20323aed172a29afd9ab3a0" className="block dark:hidden" alt="Insights query latency" width="3356" height="2286" data-path="images/metal/insights-p50-p95-p99.png" />

  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-p50-p95-p99-darkmode.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=d30c65f24f34b7832788ef87f38cd69d" className="hidden dark:block" alt="Insights query latency" width="3356" height="2286" data-path="images/metal/insights-p50-p95-p99-darkmode.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-p50-p95-p99-p99.9.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=893a0e726f768025c815afec1de833cb" className="block dark:hidden" alt="Insights query latency" width="3354" height="2286" data-path="images/metal/insights-p50-p95-p99-p99.9.png" />

  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-p50-p95-p99-p99.9-darkmode.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=087980d7086d6c4df60eea8e5d4d36c3" className="hidden dark:block" alt="Insights query latency" width="3356" height="2286" data-path="images/metal/insights-p50-p95-p99-p99.9-darkmode.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-anomalies.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=d4b08adc924d5fa0936b04ae32f0ece1" className="block dark:hidden" alt="Insights anomalies" width="3356" height="2286" data-path="images/metal/insights-anomalies.png" />

  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-anomalies-darkmode.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=14c4ffe783356cf6239825f7a9a4ef9e" className="hidden dark:block" alt="Insights anomalies" width="3356" height="2286" data-path="images/metal/insights-anomalies-darkmode.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-qps.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=0e1de73bcda719baa1518378f3ca1d2f" className="block dark:hidden" alt="Insights queries" width="3356" height="2286" data-path="images/metal/insights-qps.png" />

  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-qps-darkmode.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=87c49a093a953d0fcbcbda3803d87b06" className="hidden dark:block" alt="Insights queries" width="3356" height="2286" data-path="images/metal/insights-qps-darkmode.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-rows-read.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=4f8c887d32f2c96af9063962070e8468" className="block dark:hidden" alt="Insights rows read" width="3356" height="2286" data-path="images/metal/insights-rows-read.png" />

  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-rows-read-darkmode.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=e4295122d8f84b474d8b1d57704ba598" className="hidden dark:block" alt="Insights rows read" width="3356" height="2286" data-path="images/metal/insights-rows-read-darkmode.png" />
</Frame>
...
When you upgrade a database to Metal, the (greatly simplified) steps that happen in the background are:
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-rows-written.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=ef0e858ed33ed88bbd6018c5470b4319" className="block dark:hidden" alt="Insights rows written" width="3356" height="2286" data-path="images/metal/insights-rows-written.png" />

  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/insights-rows-written-darkmode.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=95e154b0cf6657b9e784d33bf2c54c49" className="hidden dark:block" alt="Insights rows written" width="3356" height="2286" data-path="images/metal/insights-rows-written-darkmode.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/AJPY38bILe2zenXX/images/metal/cpu-ram.png?fit=max&auto=format&n=AJPY38bILe2zenXX&q=85&s=7fc3ab4897a39c993693d83d0870b1e7" className="block dark:hidden" alt="Insights rows written" width="1182" height="414" data-path="images/metal/cpu-ram.png" />

  <img src="https://mintcdn.com/planetscale-2/AJPY38bILe2zenXX/images/metal/cpu-ram-darkmode.png?fit=max&auto=format&n=AJPY38bILe2zenXX&q=85&s=5865794e25b67daf295a8f321135f349" className="hidden dark:block" alt="Insights rows written" width="1172" height="416" data-path="images/metal/cpu-ram-darkmode.png" />
</Frame>
...
<Frame>
  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/primary-metrics.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=f2587e892a4c1f3ff7246fcabb840a61" className="block dark:hidden" alt="Database primary metrics" width="1334" height="2072" data-path="images/metal/primary-metrics.png" />

  <img src="https://mintcdn.com/planetscale-2/qp-ZKr_vKb0iLpeb/images/metal/primary-metrics-darkmode.png?fit=max&auto=format&n=qp-ZKr_vKb0iLpeb&q=85&s=4a957a6b2f6aa5c4e218a43c589e6147" className="hidden dark:block" alt="Database primary metrics" width="1334" height="2072" data-path="images/metal/primary-metrics-darkmode.png" />
</Frame>
...
[**Network-attached storage**](../plans/planetscale-skus.md#network-attached-storage) (Amazon Elastic Block Storage or Google Persistent Disk) databases store all data on storage volumes that are attached to your database's compute resources over the network.
